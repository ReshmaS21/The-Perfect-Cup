    ...
    <div class="container">
        ...
        <div class="row">
            <div class="box">
                ...
                <div class="col-md-8">
                    <!-- Embedded Google Map using an iframe - to select the location on Google maps and paste the link as iframe src. -->
                    <!-- If we want to use the Google Maps API instead then have at it -->
                    <!-- go to maps.google.com and select place in the navigation choose share and embed...and get the embed html code copy and paste -->
                    <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d3440.6362708252536!2d78.09515213429603!3d9.922485963837069!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sin!4v1677329414971!5m2!1sen!2sin" 
                        width="100%" height="450" style="border:0;" allowfullscreen="" 
                        loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
                <div class="col-md-4">
                    <p>Phone:
                        <strong>6369589164</strong>
                    </p>
                    <p>Email:
                        <strong><a href="mailto:sreshma2112@gmail.com">sreshma2112@gmail.com</a></strong>
                    </p>
                    <p>Address:
                        <strong>Shop No. 32, Opp. to Trends
                            <br>By-Pass Road, Madurai 625016</strong>
                    </p>
                </div>
